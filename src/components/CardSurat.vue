<template>
   <router-link :to="'/surat/' + surat.nomor" class="flex items-center py-3 px-4 bg-white rounded-lg hover:shadow-md active:bg-slate-300 transition-all duration-300 ease-out">
      ...
      <h2 class="text-primary text-2xl ml-auto font-arab">{{ surat.nama }}</h2>
   </router-link>
</template>
