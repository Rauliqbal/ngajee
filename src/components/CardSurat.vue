<template>
  <router-link to="#" class="flex items-center py-3 px-4 bg-white rounded-lg">
    ...
    <div class="ml-4">
      ...
      <h3 class="text-sm text-slate-500 ">{{surat.tempat_turun}} - {{surat.jumlah_ayat}} ayat</h3>
    </div>
    <h2 class="text-primary text-2xl ml-auto">{{surat.nama}}</h2>
  </router-link>
</template>
