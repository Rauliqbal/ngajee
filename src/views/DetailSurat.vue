   ...
   <main>
      <div class="px-4 pb-8 min-h-screen bg-[#DEF5F6]">
         <header class="z-30 fixed inset-x-0 bg-primary flex items-center justify-between py-6 px-4 shadow-md">
            ...
            <div class="absolute top-0 left-0 bottom-0 h-screen bg-black/40 w-full translate-x-full peer-checked:-translate-x-0 transition-all duration-300" for="hamburger">
