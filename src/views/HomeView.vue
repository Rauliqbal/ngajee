            ...
            <div class="bg-white h-full max-w-[18rem] flex flex-col">
              ...
              <div class="flex flex-col pt-2">
                    ...
                    <g clip-path="url(#clip0_105_367)">
                      ...
                      <g clip-path="url(#clip1_105_367)">
                        ...
                        <rect
                          ...
                          width="4.22254"
                          height="1.97067"
                          transform="rotate(-43.9232 15.5916 18.5097)"
                          fill="#808080"
                        />
                        <rect
                          x="18.406"
                          ...
                          width="4.01355"
                          height="2.15261"
                          transform="rotate(-132.228 18.406 8.44672)"
                          fill="#808080"
                        />
                      </g>
                      <rect
                        ...
                        width="4.01355"
                        height="2.83422"
                        transform="rotate(-178.196 13.9901 4.95917)"
                        fill="#808080"
                      />
                      <rect
                        x="19"
                        ...
                        width="4.22254"
                        height="2.18778"
                        transform="rotate(-87.8856 19 14.2197)"
                        fill="#808080"
                      />
                      <rect
                        x="6.0116"
                        ...
                        width="4.01355"
                        height="3.41833"
                        transform="rotate(-178.196 6.0116 13.9592)"
                        fill="#808080"
                      />
                      <rect
                        x="14.0366"
                        ...
                        width="4.01355"
                        height="2.49593"
                        transform="rotate(-178.196 14.0366 21.7493)"
                        fill="#808080"
                      />
                    </g>
                    <defs>
                ...
                >
                  ...
                  >
                    <path
                      d="M12 1C18.0775 1 23 5.9225 23 12C23 18.0775 18.0775 23 12 23C5.9225 23 1 18.0775 1 12C1 5.9225 5.9225 1 12 1ZM13.375 6.5C13.375 5.74375 12.7563 5.125 12 5.125C11.2437 5.125 10.625 5.74375 10.625 6.5C10.625 7.25625 11.2437 7.875 12 7.875C12.7563 7.875 13.375 7.25625 13.375 6.5ZM13.375 18.875V10.625H10.625V18.875H13.375Z"
                      fill="#808080"
                    />
                  </svg>
                </a>
              ...
              <div
                class="flex flex-col items-center justify-center mt-auto mb-4"
              >
          ...
          >
            <g clip-path="url(#clip0_105_133)">
              <circle
                ...
                cy="10.66"
                r="6.12354"
                transform="rotate(-45.1487 10.66 10.66)"
                stroke-width="3"
              />
              <rect
                ...
                height="10"
                rx="1.5"
                transform="rotate(-45.1487 13.2343 15.3368)"
              />
            </g>
            <defs>
