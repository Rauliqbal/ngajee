<template>
   <div class="px-4 min-h-screen bg-[#def5f6]">
      <header class="z-30 fixed top-0 inset-x-0 bg-primary flex flex-col py-6 px-4 shadow-md">
         ...
         <form class="flex items-center relative mt-4" @submit.prevent="setSurats">
            <input
      ...
      <div class="pt-36">
         <div v-if="surats.length < 0">
            <h5 class="text-black text-2xl">KOSONG</h5>
         </div>
         <div v-else class="grid grid-cols-1 gap-3 mt-4 pb-8">
